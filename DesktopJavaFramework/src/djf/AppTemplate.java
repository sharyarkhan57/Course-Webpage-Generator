...
public abstract class AppTemplate extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //ask what Language the user would like to use
        Alert alert = new Alert(AlertType.CONFIRMATION);
        alert.setTitle("Language Selection");
        alert.setHeaderText("Which Language Would You Like To Load The App In?");
        ...
        if (result.get() == buttonTypeOne){
            ...
            try {
                // LOAD APP PROPERTIES, BOTH THE BASIC UI STUFF FOR THE FRAMEWORK
                // AND THE CUSTOM UI STUFF FOR THE WORKSPACE
                boolean success = loadProperties(APP_PROPERTIES_SPANISH_FILE_NAME);
