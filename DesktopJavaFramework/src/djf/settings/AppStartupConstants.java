...
public class AppStartupConstants
{
    ...
    public static final String APP_PROPERTIES_SPANISH_FILE_NAME = "app_properties_spanish.xml";
    ...
    public static final String PATH_EXPORT = "../TAManagerTester/public_html";
