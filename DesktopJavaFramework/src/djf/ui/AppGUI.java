...
public class AppGUI {
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        newButton = initChildButton(toolbarLeft,	NEW_ICON.toString(),	    NEW_TOOLTIP.toString(),	false);
        loadButton = initChildButton(toolbarLeft,	LOAD_ICON.toString(),	    LOAD_TOOLTIP.toString(),	false);
        saveButton = initChildButton(toolbarLeft,	SAVE_ICON.toString(),	    SAVE_TOOLTIP.toString(),	true);
        saveasButton = initChildButton(toolbarLeft,	SAVE_AS_ICON.toString(),    SAVE_AS_TOOLTIP.toString(),	true);
        exportButton = initChildButton(toolbarLeft,	EXPORT_ICON.toString(),    EXPORT_TOOLTIP.toString(),	true);
        exitButton = initChildButton(toolbarLeft,	EXIT_ICON.toString(),	    EXIT_TOOLTIP.toString(),	false);

        //added functionality 
        HBox toolbarRight= new HBox();
        undoButton= initChildButton(toolbarRight,	UNDO_ICON.toString(),	    UNDO_TOOLTIP.toString(),	false);
        redoButton= initChildButton(toolbarRight,	REDO_ICON.toString(),	    REDO_TOOLTIP.toString(),	false);
        aboutButton= initChildButton(toolbarRight,	ABOUT_ICON.toString(),	    ABOUT_TOOLTIP.toString(),	false);
	
        fileToolbarPane.getChildren().addAll(toolbarLeft,toolbarRight);
        fileToolbarPane.setSpacing(500);
